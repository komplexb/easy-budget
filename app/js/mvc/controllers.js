...
easyBudget.controller('BudgetNotificationsCtrl', ['$scope', '$rootScope', function ($scope, $rootScope) {
	...
	//we want to be able to access this function from anywhere so we use $rootScope	
	$rootScope.updateBudgetNotification = function()	{
		var expensePercentage = ($rootScope.totalExpense / ($rootScope.totalIncome + $rootScope.totalExpense)) * 100; //use rootScope to access these variables from anywhere as well
...
easyBudget.controller('IncomeCtrl', ['$scope', '$rootScope', function ($scope, $rootScope) {
	...
	//watch total income for changes to trigger the UI update
...
easyBudget.controller('ExpenseCtrl', ['$scope', '$rootScope', function ($scope, $rootScope) {
	...
	//watch total expense for changes to trigger the UI update
